...
> If you are creating Stacks from existing compose projects that are "plain old folders" on your machine (like with dockge) you can use my [komodo-import tool](https://foxxmd.github.io/komodo-import) generate the configuration for these Stacks semi-automatically.
{: .prompt-tip}
