...
> If you are creating Stacks from existing compose projects on your machine (like with dockge) you can use my [komodo-import tool](https://foxxmd.github.io/komodo-import) generate the configuration for these Stacks automatically. It handles plain ol' folders, git repositories, and parsing from running compose. Try out the [interactive Quickstart docs](https://foxxmd.github.io/komodo-import/docs/quickstart) to easily setup the tool for your machine.
{: .prompt-tip}
